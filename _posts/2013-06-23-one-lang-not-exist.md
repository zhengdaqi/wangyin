...
所以我觉得 Lisp 和 Scheme 的宏是很重要的东西。然而我的观点是，宏一定要少用，要在非常有必要的时候才定义宏。否则你的语言里就会出现很多奇怪的结构，这些结构没法用函数的语义来理解。这样就造成了程序员之间交流的障碍。在 Common Lisp 里面有很多种 looping macro，就这样的例子，它们让 Common Lisp 的程序难以理解。
