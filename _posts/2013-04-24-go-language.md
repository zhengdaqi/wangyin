...
有挺多人问过我对 Google 的 [Go 语言](http://golang.org)的看法，我一直都没有直接回答。其实很早以前看过一下 Go 的介绍，当时我就觉得是一些门外汉设计的蹩脚玩具。（对，Rob Pike 确实是个门外汉。）那语法设计得就像是故意想要显得跟其它语言（C，Java）不同，却把它们语法已有的那些优点都丢掉了。当时我就觉得，Google 设计这些语言貌似并不是想把它们投入实用，而只不过是想显示给世人：“看，Google 也会设计程序语言。”
