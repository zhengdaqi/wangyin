...
有挺多人问过我对 Google 的 [Go 语言](http://golang.org)的看法，我一直都没有直接回答。其实很早以前看过一下 Go 的介绍，当时我就觉得是一些门外汉设计的蹩脚玩具。（对，Rob Pike 确实是个门外汉。）那语法设计得就像是故意想要显得跟其它语言不同。Google 设计这些语言，只不过是想显示给大家：“看，Google 也会设计程序语言。”
