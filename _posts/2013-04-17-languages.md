...
所以虽然我看清楚了 Haskell 的缺点，我不想再使用它，我对它的程序员的高傲态度也感到厌倦，然而我的脑子里却留下了它教会我的东西。对 Haskell 的理解，让我成为了一个更好的 Scheme 程序员，一个更好的 Java 程序员，C++ 程序员，甚至 shell 脚本程序员。我能够在任何语言里再现 Haskell 的编程方式的精髓。
