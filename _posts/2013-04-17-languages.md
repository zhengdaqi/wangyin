...
所以我不想再使用 Haskell，我对它的程序员的高傲态度也感到厌倦，然而我的脑子里却留下了它教会我的东西。对 Haskell 的理解，让我成为了一个更好的 Scheme 程序员，更好的 Java 程序员，更好的 C++ 程序员，甚至更好的 shell 脚本程序员。我能够在任何语言里再现 Haskell 的编程方式的精髓。然而，让我继续用 Haskell 却像是让我坐牢一样。本来很简单的事情，到 Haskell 里面就变成这样那样莫名其妙的新术语.
